/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareBindings` (hash: 7898beadf948514d200dbd681b1529ac)
// Runtime types generated with workerd@1.20260722.1 2026-07-28 nodejs_compat
interface __BaseEnv_CloudflareBindings {
  ENVIRONMENT?: 'development' | 'production'
  ALLOWED_ORIGIN?: ''
  LOGGER_LEVELS?: 'info'
  IP_LOG_LEVEL?: 'partial'
}
...
declare namespace NodeJS {
  interface ProcessEnv extends StringifyValues<
    Pick<Cloudflare.Env, 'ENVIRONMENT' | 'ALLOWED_ORIGIN' | 'LOGGER_LEVELS' | 'IP_LOG_LEVEL'>
  > {}
}
